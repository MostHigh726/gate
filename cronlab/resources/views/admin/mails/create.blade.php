            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="alert alert-danger">
                        <p class="text-center">
                            You can send email to multiple address at a time. Please write your multiple email address like <br><strong>"robi@gmail.com,robi2@gmail.com,robi3@gmail.com"</strong>. <br>
                            Note: Please don't add any space after comma like <strong>"robi@gmail.com, robi2@gmail.com, robi3@gmail.com"</strong>.
                        </p>
                    </div>
                    <form action="{{route('adminEmail.send')}}" role="form" id="contact-form"  method="POST">
                        ...
                        <div class="card-content">
                            ...
                            <div class="form-group label-floating">
                                <label for="email" class="control-label">Send To (Separate By Comma)</label>
