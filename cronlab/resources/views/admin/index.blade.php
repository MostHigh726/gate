    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    ...
                    <h4 class="card-title">{{$count->total}}</h4>
                </div>
                <div class="card-footer">
                    <div class="stats">
                        <i class="material-icons text-danger">account_circle</i>
                        <a href="{{route('admin.users.index')}}">Click Here To See Member List</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category">Active Members</p>

                    <h4 class="card-title">{{$count->active}}</h4>
                </div>
                <div class="card-footer">
                    <div class="stats">
                        <i class="material-icons">compare_arrows</i>
                        <a href="{{route('admin.users.verified')}}">Click Here To See Member List</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category">Total Banned</p>

                    <h4 class="card-title">{{$count->banned}}</h4>
                </div>
                <div class="card-footer">
                    <div class="stats">
                        <i class="material-icons">eject</i>
                        <a href="{{route('admin.users.banned')}}">Click Here To See Member List</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-content">
                    <p class="category">Total Un-Verified</p>
                    <h4 class="card-title">{{$count->unverified}}</h4>
                </div>
                <div class="card-footer">
                    <div class="stats">
                        <i class="material-icons">hourglass_empty</i>
                        <a href="{{route('admin.users.unverified')}}">Click Here To See Member List</a>
                    </div>
                </div>
            </div>
        </div>
