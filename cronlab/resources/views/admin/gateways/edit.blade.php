                ...
                <div class="card-content">
                    ...
                    <br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    <select class="selectpicker" name="mode" data-style="btn btn-warning btn-round" title="Select Gateway Mode" data-size="7">
                    ...
                    <a href="{{route('admin.gateways.index')}}" class="btn btn-rose">Cancel Edit</a>
