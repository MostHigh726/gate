        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form action="{{route('admin.user.advertEditSubmit', ['id'=>$advertisement->id])}}" method="post">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input id="ptc" name="ad_link" type="url" value="{{$advertisement->ptc->ad_link}}" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input id="rewards" name="rewards" type="text" value="{{$advertisement->ptc->rewards}}" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input id="hit" name="hit" type="number" value="{{$advertisement->ptc->hit}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group label-floating">
                                    ...
                                    <input id="duration" name="duration" type="number" value="{{$advertisement->ptc->duration}}" class="form-control">
                        ...
                        <a href="{{route('admin.user.advertAll')}}" class="btn btn-rose">Cancel Edit</a>
