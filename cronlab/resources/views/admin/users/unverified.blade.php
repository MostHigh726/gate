...
@section('title', 'All Unverified Member Profile')
    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                ...
                <br>
                <h4 class="card-title">All Unverified Members</h4>
                <div class="card-content">
                    ...
                    @else
                        <h1 class="text-center">There is no Unverified user</h1>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card card-content">
                    <div class="card-content">
                        <form action="{{route('admin.users.unverified')}}" method="get">
