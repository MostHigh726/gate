...
@section('title', 'All Active Member Profile')
    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                ...
                <br>
                <h4 class="card-title">All Active Members</h4>
                <div class="card-content">
                    ...
                    @else
                        <h1 class="text-center">There is no active user</h1>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card card-content">
                    <div class="card-content">
                        <form action="{{route('admin.users.verified')}}" method="get">
