    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <br>
                <h4 class="card-title">{{$user->name}}'s Total Referral</h4>
                <div class="card-content">
                    ...
                    <div class="table-responsive">
                                ...
                                @foreach($referrals as $referral)
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions text-center">
                                            <a href="{{route('admin.user.show', $referral->user->id)}}" type="button"
                                               rel="tooltip" class="btn btn-success">Show</a>
                                        </td>
                                        <td class="td-actions text-center">
                                            <a href="{{route('admin.user.edit', $referral->user->id)}}" type="button"
                                               rel="tooltip" class="btn btn-rose">Edit</a>
                                        </td>
                                        <td class="td-actions text-center">
                                            <a href="{{route('admin.user.delete', $referral->user->id)}}" type="button"
                                               rel="tooltip" class="btn btn-danger">Suspend</a>
                                        </td>
                                    </tr>
                        ...
                        @else
                            <h1> This Member Doesn't have Any Referral .</h1>
