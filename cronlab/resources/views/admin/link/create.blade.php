...
@section('title', 'Create New Link Share Advertisement')
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Link Share Section -
                        <small class="category">Create New Link Share Advertisement</small>
                    </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group label-floating">
                                ...
                                <input id="ptc" name="link" type="url" class="form-control">
