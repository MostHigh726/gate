                        ...
                        <div class="tab-pane" id="features">
                            ...
                            <form action="{{route('featuresSettings',['id'=>$settings->id])}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <p class="text-danger text-center"> This is a Link Share Settings. If you Turn Off then Link Share System Will be Turned off. </p>
                                        <div class="form-group label-floating">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <p class="text-danger text-center"> This is a User Buy Traffic Settings. If you Turn Off, No one can see Buy Traffic option. </p>
                                        <div class="form-group label-floating">
                                    ...
                                    <div class="col-md-4">
                                        <p class="text-danger text-center"> This is a User Daily Rewards Settings. If you Turn Off, No one can daily rewards will be off. </p>
                                        <div class="form-group label-floating">
                                            <select class="selectpicker" name="daily_login" data-style="btn btn-success btn-round" title="Select Status" data-size="7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group label-floating">
                                            ...
                                            <label  class="control-label" for="minimum_transfer">Minimum Member to Member Fun Transfer (in {{config('app.currency_code')}})</label>
                                            <input id="minimum_transfer" name="minimum_transfer" type="text" value="{{$settings->minimum_transfer + 0}}" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group label-floating">
                                            ...
                                            <label  class="control-label" for="daily_rewards">Daily Login Rewards For Members (in {{config('app.currency_code')}})</label>
