...
@section('title', 'Create New Paid To View Advertisement')
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Paid To View Section -
                        <small class="category">Create New PPV Advertisement</small>
                    </h4>
                    ...
                    <button type="submit" class="btn btn-success pull-right">Create PPV</button>
