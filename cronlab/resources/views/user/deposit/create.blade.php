                                ...
                                <div class="tab-pane active" id="local">
                                    ...
                                    @foreach($errors->all() as $error)
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-md-offset-3">
                                                <div class="form-group label-floating">
                                                    <select class="selectpicker" name="gateway" data-style="btn btn-warning btn-round" data-size="7" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <label  class="control-label" for="amount">Deposit Amount</label>
                                                    <input id="amount" name="amount" type="text" value="{{ $request['amount'] }}" class="form-control" readonly required>
