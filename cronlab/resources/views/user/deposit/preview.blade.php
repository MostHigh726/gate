                ...
                <div class="card card-content">
                    <div class="card-content">
                        <div class="alert alert-info">
                                <span> You have selected <b>{{$gateway->name}}</b>. Please note that <b>{{$gateway->name}}</b> will be charge you <b>{{config('app.currency_symbol')}} {{$gateway->fixed}}</b> fixed + <b>{{$gateway->percent}}%</b> fee in every deposit.</span>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
