...
<script>
    function move() {
        ...
        var width = 0;
        var id = setInterval(frame,{{$log->ptc->duration *10}});
        function frame() {
            if (width >= 100) {
                ...
                confirmButton.setAttribute('href','{{route('uPlanLog')}}');
                clearInterval(id);
    ...
    <iframe src="{{$log->ptc->ad_link}}" style="border: 0; position:absolute; top: 14%; left:0; right:0; bottom:0; width:100%; height:100%"></iframe>
