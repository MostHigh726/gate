...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-offset-2">
            <img src="{{asset('img/728x90.png')}}" class="img-rounded" alt="Google Ad">
        </div>
        <div class="row">
            <div class="col-md-3">
                <div class="col-md-offset-1">
                    <img src="{{asset('img/160x600.gif')}}" class="img-rounded" alt="Google Ad">
                </div>
            </div>
            <br>
            <br>
            ...
            <br>
            <div class="col-md-6">
                <iframe width="560" height="345" src="//www.youtube.com/embed/{{$video->ppv->code}}?autoplay=1"
...
@include('includes.public.adsBlock')
</body>
<!--   Core JS Files   -->
