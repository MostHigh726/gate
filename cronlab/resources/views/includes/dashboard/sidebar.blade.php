...
<div class="sidebar-wrapper">
    ...
    <ul class="nav">
        ...
        @if($settings->aff_share == 1)
            ...
            <li class=" {{ Request::is('user/link/shares') ? "active" :"" }}">
                <a href="{{route('userLink.share')}}">
                    <i class="material-icons">perm_media</i>
                    <p>View Link Share
                    </p>
                </a>
        ...
        @if($settings->buy_traffic == 1)
            <li class=" {{ Request::is('user/advertisements/plan') ? "active" :"" }}">
                <a href="{{route('userAdPlan')}}">
                    <i class="material-icons">work</i>
                    <p>Buy Traffic
                    </p>
                </a>
        ...
        @if($settings->ptc == 1)
            ...
            <li class=" {{ Request::is('user/advertisements/history') ? "active" :"" }}">
                <a href="{{route('uPlanLog')}}">
                    <i class="material-icons">work</i>
                    <p>My Traffic Plan
                    </p>
                </a>
        ...
        <li class="{{ Request::is('user/funds/transfer/history') ? "active" :"" }}">
            <a href="{{route('userFundsTransfer.history')}}">
                <i class="material-icons">transfer_within_a_station</i>
