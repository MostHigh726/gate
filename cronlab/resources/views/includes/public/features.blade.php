<div class="features-1">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <h5 class="description">Anyone can make investments using our website. The interface is so easy to use that even someone with zero experience can figure it out. In addition, our experts are available online 24/7 and are always ready to help with Growthcapitalinvestment . We help our clients earn money on the volatility of the Finance market. Today, this is an industry with a market capitalization of $17,654,129</h5>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="info">
                ...
                <p>Growth Capital Investment Support Team experts are always here to answer your questions. You can ask them any time of the day and receive a prompt response.</p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="info">
                ...
                <p>We are a San Francisco Based Company. We Don't Support Scam and We do not. We are government verified company. We have License to do this business and Leading This.</p>
            </div>
        </div>
