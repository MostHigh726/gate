...
class UserFundsTransferController extends Controller
{
    ...
    public function history(){
        ...
        return view('user.transfer.log',compact('logs'));
    }
    ...
    public function self(Request $request){
        ...
        if ($request->account == 1){
            ...
            if ($request->transfer == 1){
                ...
                $log->user_id = $user->id;
                $log->name = 'Deposit Balance To';
                $log->email = 'Deposit Balance';
    ...
    public function verify($reference){
        ...
        return view('user.transfer.verify',compact('transfer'));
    }
    public function resend($reference){
        ...
        if ($interval < 15){
            ...
            session()->flash('message', 'Sometimes it can take up to 15 minutes to reach you. Please wait at lest 15 then request again.');
            Session::flash('type', 'error');
            ...
            session()->flash('message', 'We have send a verification code again your email address please check.  Write down that 6 digit code to verify and transfer your money.');
    ...
    public function others(Request $request){
        ...
        if ($type == 1){
            ...
            if ($settings->minimum_transfer > $reamount){
                ...
                session()->flash('message', "The Minimum Amount to Transfer $".$settings->minimum_transfer." Please Increase money first.");
                Session::flash('type', 'error');
            ...
            session()->flash('message', 'We have send a verification code your email address please check.  Write down that 6 digit code to verify and transfer your money.');
            Session::flash('type', 'warning');
